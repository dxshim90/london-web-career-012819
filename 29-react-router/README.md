...
- Can't share links to specific content
- It can complicate your component history to have everything rendering essentially on a single page
- Use the forward and back buttons to navigate website
- Hitting refresh starts the application from the beginning 
