...
Good 
Modular design
JSX - best of both worlds of HTML and JS
Lot of available libraries - so hot
Documentation is great!
Error feedback

Bad
Modular design - easy to lose track of components (lack of discipline)
Quite verbose / requires a lot of knowledge of syntax
Managing state and props can be confusing
Hard to keep track of data past 1-2 levels of props
Bugs harder to find


Ehhhhh
Do something a hundred different ways - you'll get a ton of different
...
Store - this is the source of your state (data)
Reducer - controls state
Dispatch - allows you to write to state that is kept kept inside store (setState)
getState - allows you to read the state that is kept inside of your store
